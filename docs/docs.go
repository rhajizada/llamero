    ...
    "paths": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/ProcessModelResponse"
                            }
                        }
                    },
                    "404": {
        ...
        "/api/profile/tokens": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "PAT request",
                        "name": "payload",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/CreatePersonalAccessTokenRequest"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/PersonalAccessTokenResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
